...
import EndlessPlanet from '../assets/endless_planet.mp4'
import './Counter.scss'

export const Counter = ({ counter, increment, doubleAsync }) => (
    <div className='pageCenter'>
        <video muted autoPlay id='bgvid' src={EndlessPlanet} loop>
        </video>
        <div className='main'>
                ...
                <div className='row story'>
                    <div className='story'>
                        ...
                        <p>Previously, he worked in the music industry processing licenses and deals
                            for all the major players: Spotify, Apple, Google, major music labels, et al.
                            The software he wrote turned data into royalty checks for everyone whose music
                            you have ever enjoyed.
                        </p>
                        <p>Presently, he writes the <a href='https://www.makerbot.com/print/'
                            target='blank'>desktop app</a> for 3D-printing dreams to life,
                            while pushing model-slicing and toolpathing algorithms towards industry innovation.
                        </p>
